...
kubectl create secret docker-registry s3b-acr-secret --docker-server=awokenin.azurecr.io --docker-username=s3blabs --docker-password=acual_secret_from_portal --docker-email=your_email_id --namespace=awkn-dev

```

```bash
kubectl create secret docker-registry acr-secret --docker-server=s3blabs.azurecr.io --docker-username=awokenin --docker-password=acual_secret_from_portal --docker-email=your_email_id --namespace=awkn-dev
```
