...
2. In the search box (case-insensitive), enter Container Registry and click create. A screen similar to this is displayed.
![image](https://github.com/user-attachments/assets/7203bce0-1ddf-4aa7-b058-c1092ae38cb9)

3. Enter a value for Registry Name. Note this name for later reference.
4. For Location, select a location with enough resources for your deployment.
5. For Admin user, select Enable.
6. For SKU, choose the value you need (basic, medium, or standard).
![image](https://github.com/user-attachments/assets/032ee4c0-3452-425a-8635-e486d8368a16)
7. Click Create to create the Azure Container Registry.
